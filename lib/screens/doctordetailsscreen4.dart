...
class DoctorDetailsScreen4 extends StatefulWidget {
  const DoctorDetailsScreen4({Key? key}) : super(key: key);

  @override
  State<DoctorDetailsScreen4> createState() => _DoctorDetailsScreen4State();
}

class _DoctorDetailsScreen4State extends State<DoctorDetailsScreen4> {
  @override
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        'lib/assets/doc7.png'), // Replace with actual image URL
                  ),
                  SizedBox(width: 4.w),
                  Expanded(
                    child: Column(
