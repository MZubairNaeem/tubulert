...
class DoctorDetailsScreen2 extends StatefulWidget {
  const DoctorDetailsScreen2({Key? key}) : super(key: key);

  @override
  State<DoctorDetailsScreen2> createState() => _DoctorDetailsScreen2State();
}

class _DoctorDetailsScreen2State extends State<DoctorDetailsScreen2> {
  @override
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        'lib/assets/doc3.png'), // Replace with actual image URL
                  ),
                  SizedBox(width: 4.w),
                  Expanded(
                    child: Column(
