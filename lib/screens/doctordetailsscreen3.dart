...
class DoctorDetailsScreen3 extends StatefulWidget {
  const DoctorDetailsScreen3({Key? key}) : super(key: key);

  @override
  State<DoctorDetailsScreen3> createState() => _DoctorDetailsScreen3State();
}

class _DoctorDetailsScreen3State extends State<DoctorDetailsScreen3> {
  @override
          ...
          children: [
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        'lib/assets/doc6.png'), // Replace with actual image URL
                  ),
                  SizedBox(width: 4.w),
                  Expanded(
                    child: Column(
            ...
            Row(
              ...
              children: [
                ...
                availabilityButton('Wed 24', false),
                availabilityButton('Thur 25', false),
                availabilityButton('Fri 26', true),
  ...
  Widget timeSelectionWidget() {
    return Wrap(
      ...
      children: [
        ...
        timeButton('07:00', false),
        timeButton('08:00', false),
        timeButton('09:00', true),
