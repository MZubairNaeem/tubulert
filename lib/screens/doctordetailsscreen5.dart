...
class DoctorDetailsScreen5 extends StatefulWidget {
  const DoctorDetailsScreen5({Key? key}) : super(key: key);

  @override
  State<DoctorDetailsScreen5> createState() => _DoctorDetailsScreen5State();
}

class _DoctorDetailsScreen5State extends State<DoctorDetailsScreen5> {
  @override
          ...
          children: [
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        'lib/assets/doc8.png'), // Replace with actual image URL
                  ),
                  SizedBox(width: 4.w),
                  Expanded(
                    child: Column(
            ...
            Row(
              ...
              children: [
                ...
                availabilityButton('Thur 25', true),
